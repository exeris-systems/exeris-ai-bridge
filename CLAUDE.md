...
| `build:*`  | The **user's own project**: emitted `DomainMetadata` (shipped), artefact preview, L1/L2 detach state, decoded processor diagnostics *(rest of 0.6.0)* — read-only | `<projectRoot>/target/classes/exeris-metadata/` |
