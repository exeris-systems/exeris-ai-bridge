...
5. If new ADR required, reserve number in `adr-index.md` of `exeris-systems/exeris-docs` first.
...
- Index entry: `adr-index.md` in `exeris-systems/exeris-docs` — proposed number `ADR-NNN`
